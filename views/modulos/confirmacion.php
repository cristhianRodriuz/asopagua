            ...
            <div class="card">
                ...
                <div class="card-body text-center">
                    ...
                    <div class="form-group mt-3">
                        <button class="btn" style="background-color: #003333;">Regresar a la tienda</button>
                    </div>
                </div>
            </div>
        </div>
...
<script>    
    $().ready(function(){
        ...
        if(localStorage.getItem("detalle_pedido")){
            let detalle_pedido = JSON.parse(localStorage.getItem("detalle_pedido"));
            $("#nameCode").html(detalle_pedido.codigo);
            $("#emailAddress").html(detalle_pedido.email);
            $("#totalPedido").html('$' + detalle_pedido.total)
            console.log(detalle_pedido.codigo);
        }
    })
</script>
